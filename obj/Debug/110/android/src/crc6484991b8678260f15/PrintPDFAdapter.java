...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("XamarinPdfPrint.Common.PrintPDFAdapter, XamarinPdfPrint", PrintPDFAdapter.class, __md_methods);
	}
	...
	public PrintPDFAdapter ()
	{
		...
		if (getClass () == PrintPDFAdapter.class)
			mono.android.TypeManager.Activate ("XamarinPdfPrint.Common.PrintPDFAdapter, XamarinPdfPrint", "", this, new java.lang.Object[] {  });
	}
	...
	public PrintPDFAdapter (android.content.Context p0, java.lang.String p1)
	{
		super ();
		if (getClass () == PrintPDFAdapter.class)
			mono.android.TypeManager.Activate ("XamarinPdfPrint.Common.PrintPDFAdapter, XamarinPdfPrint", "Android.Content.Context, Mono.Android:System.String, mscorlib", this, new java.lang.Object[] { p0, p1 });
	}
